...
class Car{
	...
	//alt + shhift + s -> ganarate hash equals
...
public class EqualsDemo {
	public static void main(String[] agrs) {
		...
		// == -> c1과 c2 가 같은 객체를 참조하면 true, 그렇지 않으면 false
		System.out.println(c1 == c2);
		// equals ->  c1과 c2 가 같은 객체를 참조하면 true, 그렇지 않으면 false
		System.out.println(c1.equals(c2));
		
		//해쉬코드란 객제가 가지는 유일한 값, 반드시 유일한 값을 가져야 함/
		...
		// c3.equals(c4)의 결과가 teue 이면 c3, c4의 hashCode 값은 같고
		//  c3.equals(c4)의 결과가 false이면 c3, c4의 hashCode 값은 달라야한다.
